...
urlpatterns = [
    ...
    path('games/<int:game_id>/games/<int:ignore_id>/assoc_location/<int:location_id>/', views. assoc_location, name='assoc_location'),
    path('games/<int:game_id>/play', views.play, name='play' )
]
